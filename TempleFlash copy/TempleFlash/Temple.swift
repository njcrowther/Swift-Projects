...
class Temple {
    var fileName: String // Was Private
    ...
    static let TEMPLES = [
		...
		Temple(filename: "jordan-river.jpg", name: "Jordan River"),
		...
		Temple(filename: "oakland-california.jpg", name: "Oakland California"),
		Temple(filename: "madrid-spain-temple-954939-mobile.jpg", name: "Madrid Spain"),
		Temple(filename: "medford-oregon.jpg", name: "Medford Oregon"),
		Temple(filename: "mexico-city-temple-lds-591669-mobile.jpg", name: "Mexico City Mexico"),
		Temple(filename: "sacramento-california.jpg", name: "Sacramento California"),
		Temple(filename: "salt-lake.jpg", name: "Salt Lake")
		]
